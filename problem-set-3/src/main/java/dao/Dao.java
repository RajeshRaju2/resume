...
public class Dao {
	...
	public List<Application> updateApplication(Application application,int applicationid) {
		...
		resumeController.addHistory(application);
	...
	public void createMailHistory(StatusApplicationHistory statusApplicationHistory) {
		getSession().saveOrUpdate(statusApplicationHistory);
	} 
}
